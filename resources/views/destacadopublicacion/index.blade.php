...
<body>
    <div class="d-flex" id="wrapper">
                    ...
                    <div class="card-deck">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if ($pb->idPub == $destacadopublicacionitem->idPublicacion)
                                <h5 class="card-title">{{$pb->nombre}}</h5>
                                <p class="card-text"> Precio: {{$pb->preVenta}} USD </p>
                                @endif
                                @endforeach
        ...
        @else
        <h2 class="display-2"> Todavía no tienes publicaciones destacadas</h2>
        @endif

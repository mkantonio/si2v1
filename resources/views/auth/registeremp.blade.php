			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Nombre es requerido">
						...
						<input class="input100" type="text" name="nomEmp" placeholder="Nombre...">
						<span class="focus-input100"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate="Ciudad es requerida">
                            <span class="label-input100">Ciudad</span>
                            <input class="input100" type="text" name="ciudad" placeholder="ciudad...">
                            <span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input" data-validate="Dirección es requerida">
                            <span class="label-input100">Dirección</span>
                            <input class="input100" type="text" name="direccion" placeholder="Dirección...">
                            <span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="NIT es requerido">
                            <span class="label-input100">NIT</span>
                            <input class="input100" type="text" name="nit" placeholder="NIT...">
                            <span class="focus-input100"></span>
                    </div>

					<div class="wrap-input100 validate-input" data-validate = "Email valido: ex@abc.xyz">
						<span class="label-input100">Email</span>
						<input class="input100" type="text" name="email" placeholder="Dirección de Email...">
						<span class="focus-input100"></span>
					</div>

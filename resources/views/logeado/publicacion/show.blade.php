        ...
        <div class="container-fluid">
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    @if ($publicacion->estado=="ocupado")
                    {{-- <p class="card-text">Estado: {{$publicacion->estado}}</p> --}}

                    <div class="p-3 mb-2 bg-danger text-white">Estado: {{$publicacion->estado}}</div>
                    @else
                    {{-- <p class="card-text">Estado: {{$publicacion->estado}}</p> --}}
                    <div class="p-3 mb-2 bg-success text-white">Estado: {{$publicacion->estado}}</div>
                    @endif
            ...
            {{--                    <div class="col-xs-3">--}}
            {{--                        <label>Nombre</label>--}}
            {{--                        <input type="text" class="form-control input-lg" value="{{$publicacion->nombre}}"
            readonly>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}
            ...
            {{--                        <input type="text" class="form-control input-lg" value="{{$publicacion->preVenta}}"
            readonly>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}
            ...
            {{--                        <input type="text" class="form-control input-lg" value="{{$publicacion->fecPub}}"
            readonly>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}
            ...
            {{--                        <input type="text" class="form-control input-lg" value="{{$publicacion->fecExp}}"
            readonly>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}
            ...
            {{--                    <div class="col-xs-3">--}}
            {{--                        <label>Estado</label>--}}
            {{--                        <input type="text" class="form-control input-lg" value="{{$publicacion->estado}}"
            readonly>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}

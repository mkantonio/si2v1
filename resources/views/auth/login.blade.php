			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				...
				{{-- <form method="POST" action="{{ route('login') }}"> --}}
					...
					<div class="wrap-input100 validate-input" data-validate="Email requerido: ex@abc.xyz">
						...
						<input class="input100" id="email" type="text" name="email" placeholder="Direccion de email...">
				...
				<a href="{{route('categoria.index')}}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Iniciar Sesión

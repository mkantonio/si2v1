...
Route::middleware(['auth', 'EsAdmin'])->group(function () {
    ...
    Route::get('reporte/publicacion', 'ReporteController@publicaciones')->name('reporte.publicaciones');
    Route::get('reporte/bitacora', 'ReporteController@bitacora')->name('gestionar.bitacora');
